...
namespace SinemaBiletSatis.UI.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            ViewBag.RolId = new SelectList(await _serviceRol.GetAllAsycn(), "Id" , "Adi"); // Veri tabanındaki kolon isimleri
            return View();
        }
        ...
        public async Task<ActionResult> CreateAsync(Kullanici kullanici)
        {
            ...
            ViewBag.RolId = new SelectList(await _serviceRol.GetAllAsycn(), "Id", "Adi");
